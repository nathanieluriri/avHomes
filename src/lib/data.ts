import type { ClientLogo, Office, Page, PriceChange, Property, SiteStat, Testimonial } from "@avhomes/contracts";
...
export function isPriceReduced(priceHistory: readonly PriceChange[], now: number = Date.now()): boolean {
