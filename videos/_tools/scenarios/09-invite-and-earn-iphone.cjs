// Video 9 on an iPhone: the same take as 09-invite-and-earn, filmed at the iPhone 18 Pro's
// 402x874 with its status bar and home indicator insets (see VIDEOS.md section 12).
const { ORIGIN, BTN, TAB, reveal: revealOn, warm } = require("../phone.cjs");
...
module.exports = {
  ...
  async run(a) {
    ...
    // 0.145, not the flat 0.1: the card's top edge sits just under the taller compact bar, as it did at 360x640.
    await reveal(a, "section[aria-labelledby='how-it-pays']", 0.145, 1500);
    a.mark("rates");
